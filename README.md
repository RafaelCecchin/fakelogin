...
- Configuração de usuários e backgrounds
- Suporte a múltiplos idiomas e layouts de teclado
- Indicadores de bateria e internet

## Como Usar 📋

1. Selecione o sistema operacional desejado.
2. Configure o número de usuários e insira os nomes.
3. Escolha o background e outras configurações desejadas.
